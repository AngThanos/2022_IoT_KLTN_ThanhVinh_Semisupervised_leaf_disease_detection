#!/bin/bash
# Run 9 UniMatch-V2_Remake sweep cells for loss = varifocal
...
#   Varifocal loss class.
#
# Usage:
#   nohup bash run_varifocal.sh > logs/varifocal_$(date +%Y%m%d_%H%M%S).log 2>&1 & disown
...
CONFIGS=(
    "exps/conf_001/varifocal/yolov11/config_semi.yaml"
    "exps/conf_001/varifocal/yolov11-sa/config_semi.yaml"
...
TOTAL=${#CONFIGS[@]}
echo "=========================================="
echo "UniMatch-V2_Remake sweep -- loss = varifocal"
